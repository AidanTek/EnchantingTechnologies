...
by PJRC. This sketch requires the Teensy 3.x and the Teensy DAC 
should be connected to an amplifier and speaker (I'm using the Prop
Shield). The sketch will play sound automatically once a serial port
is opened.
